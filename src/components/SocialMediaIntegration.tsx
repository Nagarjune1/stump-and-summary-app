...
const SocialMediaIntegration = () => {
  ...
  const generateShareableImage = async (matchData) => {
    ...
    try {
      // Create a temporary element with match scorecard using safe DOM methods
      ...
      title.style.cssText = 'margin: 0 0 20px 0; text-align: center; font-size: 24px;';
      title.textContent = '🏏 Cricket Live Score';
      container.appendChild(title);
      
      // Score box
      const scoreBox = document.createElement('div');
      scoreBox.style.cssText = 'background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; margin-bottom: 15px;';
      
      const matchTitle = document.createElement('h3');
      matchTitle.style.cssText = 'margin: 0 0 10px 0; font-size: 18px;';
      matchTitle.textContent = 'Team A vs Team B';
      scoreBox.appendChild(matchTitle);
      
      const scoresContainer = document.createElement('div');
      scoresContainer.style.cssText = 'display: flex; justify-content: space-between;';
      
      const teamAScore = document.createElement('div');
      teamAScore.textContent = 'Team A: 165/4 (18.2 ov)';
      scoresContainer.appendChild(teamAScore);
      
      const teamBScore = document.createElement('div');
      teamBScore.textContent = 'Team B: 142/8 (20 ov)';
      scoresContainer.appendChild(teamBScore);
      
      scoreBox.appendChild(scoresContainer);
      container.appendChild(scoreBox);
      
      // Footer
      const footer = document.createElement('div');
      footer.style.cssText = 'text-align: center; font-size: 14px; opacity: 0.8;';
      footer.textContent = 'Generated by Cricket Scorer Pro';
